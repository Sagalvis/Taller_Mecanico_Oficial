...
import router9 from "./routes/factura.routes.js";
import router10 from "./routes/status.routes.js";
...
//final backend
app.use(router, router1, router2, router3, router4, router5, router6, router7, router8,router9,router10)
